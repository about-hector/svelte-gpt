...
import { Drawer } from 'ui/ui-primitives/drawer';
...
<Drawer.Overlay class='fixed inset-0 bg-black/40' />
    <Drawer.Content class='bg-gray-100 flex flex-col rounded-t-[10px] max-h-[96%] mt-24 fixed bottom-0 left-0 right-0'>
        <div class="p-4 bg-white rounded-t-[10px] flex-1">
                  ...
                  <div class="max-w-md mx-auto">
                    <Drawer.Title class="font-medium mb-4">Drawer for React.</Drawer.Title>
                    <p class="text-gray-600 mb-2">
                      This component can be used as a Dialog replacement on mobile and tablet devices.
                    </p>
                    <p class="text-gray-600 mb-2">It comes unstyled and has gesture-driven animations.</p>
